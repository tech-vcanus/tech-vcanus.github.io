...
(1) Arduino IDE 상단 메뉴바의 Tools > Board(위에서 8번째) > Boards Manager... > esp32 검색 후 설치<br>
(2) 설치 완료 후, Tools > Board > ESP32 Arduino > ESP32 Dev Module 선택
...
[Adafruit 4-Channel ADC Breakouts](https://cdn-learn.adafruit.com/downloads/pdf/adafruit-4-channel-adc-breakouts.pdf),
[AI-Thinker Nodemcu-32s datasheet(핀 번호 참고)](http://wiki.ai-thinker.com/_media/esp32/docs/nodemcu-32s_product_specification.pdf)<br>
