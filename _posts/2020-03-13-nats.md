...
- add environment variable in system property and reboot
- variable name: OPEN_SSL_ROOT, path: C:\vcpkg-master\installed\x86-windows (depends on your system)
3. cmake [install](https://cmake.org/)
install cmake with windows installer
